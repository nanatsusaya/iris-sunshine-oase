...
|---|---|---|
| All page texts, posts, opening hours, URL inventory, image mapping | [`docs/content/`](../content/README.md) | `tools/extract-wp-content.mjs` |
| Price list, design system, defects, structure | `docs/analysis/` | this analysis |
...
- [x] Extract texts to `docs/content/`
